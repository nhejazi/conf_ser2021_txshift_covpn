...
Center}
    \address[emory]{Department of Biostatistics and Bioinformatics, Emory University}
      \cortext[1]{Title: Efficient estimation of stochastic interventions effects under
two-phase sampling for the analysis of vaccine efficacy trials}
    \cortext[2]{Character count: 1976 (with spaces)}
    \cortext[3]{Corresponding author: nhejazi@berkeley.edu}
    \cortext[4]{Key words: stochastic intervention, two-phase sampling, causal
inference, targeted learning, vaccine efficacy trials}
