...
date: ' `r icons::icon_style(icons::fontawesome("twitter"), fill="white")` <a href = "https://twitter.com/nshejazi" style = "color: white;">@nshejazi</a> <br> `r icons::icon_style(icons::fontawesome("link"), fill="white")` <a href="https://nimahejazi.org" style="color: white;">nimahejazi.org</a> <br> SER 2021 <br>'
header-includes:
  - \usepackage{bm}
  - \usepackage{bbm}
  - \usepackage{amsthm}
...
__Path-specific mediators of VE (MVE)__
...
__Stochastic interventional VE (SVE)__
...
* Summarizes VE thru stochastic shift interventions indexed by $\delta$.
...
.footnote[[**] [Hejazi & Benkeser (2020)](https://doi.org/10.21105/joss.02447)]

---

## SVE: pseudo-neutralizing antibody

```{r, svecorr1, echo = FALSE, out.width = "80%", fig.align = "center"}
...
```{r, svecorr2, echo = FALSE, out.width = "80%", fig.align = "center"}
